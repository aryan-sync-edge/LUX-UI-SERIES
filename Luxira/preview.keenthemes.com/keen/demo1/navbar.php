    ...
    <div id="kt_app_sidebar" class="app-sidebar  flex-column "
                        ...
                        <div class="app-sidebar-logo px-6"
                            ...
                            <div id="kt_app_sidebar_toggle"
                                ...
                                <i
                                    class="ki-duotone ki-double-left fs-2 rotate-180"><span
                        ...
                        " id="#kt_app_sidebar_menu" data-kt-menu="true"
                                        ...
                                        <div data-kt-menu-trigger="click"
                                            ...
                                            <!--begin:Menu link--><span
                                                class="menu-link"><span
                                                    class="menu-icon"><i
                                                        class="ki-duotone ki-category fs-2"><span
                                                            class="path1"></span><span
                                        ...
                                        <div
                                            class="menu-item pt-5"><!--begin:Menu content-->
                                        ...
                                        <div data-kt-menu-trigger="click"
                                            ...
                                            <!--begin:Menu link--><span
                                                class="menu-link"><span
                                                    class="menu-icon"><i
                                                        class="ki-duotone ki-educare fs-2"><span
                                                            class="path1"></span><span
                                                            class="path2"></span><span
                                                            class="path3"></span><span
                                                            class="path4"></span></i></span><span
                                        ...
                                        <div data-kt-menu-trigger="click"
                                            ...
                                            <!--begin:Menu link--><span
                                                class="menu-link"><span
                                                    ...
                                                    class="menu-arrow"></span></span><!--end:Menu link--><!--begin:Menu sub-->
                                            <div
                                                class="menu-sub menu-sub-accordion menu-active-bg"><!--begin:Menu item-->
                                                <div
                                                    class="menu-item"><!--begin:Menu link--><a
                                                        class="menu-link"
                                        ...
                                        <div
                                            class="menu-item"><!--begin:Menu link--><a
                                                ...
                                                target="_blank"><span
                                                    ...
                                                    v3.0.8</span></a><!--end:Menu link--></div>
                                        <!--end:Menu item-->
                                    </div>
                                    <!--end::Menu-->
                                </div>
                        ...
                        <div
                            ...
                            <a
                                ...
                                <i
                                    class="ki-duotone ki-document btn-icon fs-2 m-0"><span
                                        class="path1"></span><span
